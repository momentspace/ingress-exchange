...
class TradesControllerTest < ActionController::TestCase
  ...
  test "should create trade" do
    assert_difference('Trade.count') do
      post :create, trade: { agent_id: @trade.agent_id, comment: @trade.comment, exchange_type: @trade.exchange_type, name: @trade.name, place_id: @trade.place_id }
    end
  ...
  test "should update trade" do
    patch :update, id: @trade, trade: { agent_id: @trade.agent_id, comment: @trade.comment, exchange_type: @trade.exchange_type, name: @trade.name, place_id: @trade.place_id }
    assert_redirected_to trade_path(assigns(:trade))
  end
